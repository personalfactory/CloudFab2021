...
<html>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function disabilitaAction88() {
            //PERMESSO CONTROLLO MATERIE PRIME SIOLOS
    ...
    $sqlComp = selectComponentiVis($strUtAziendeComp, "descri_componente");
    $sqlFigure = selectFigureByGruppoGeoDiverseDaTipo($_SESSION['GruppoOperatore'], $_SESSION['GeograficoOperatore'], '2', $strUtAziendeFigura);
                ...
                <form id="InserisciControlloComp" name="InserisciControlloComp" method="post" onsubmit="return controllaCampi(arrayMsgErrJs)" >
                    <table width="100%">
                            ...
                            <td class="cella1" colspan="2"> 
                                <select name="Operatore" id="Operatore">
                                    ...
                                    while ($rowOper = mysql_fetch_array($sqlFigure)) {
                                        ?>
                                        <option value="<?php echo $rowOper['nominativo'] ?>"><?php echo ($rowOper['nominativo']); ?></option>
                                    <?php } ?>
                                </select></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="cella1" colspan="2"><input type="text" name="Quantita" id="Quantita" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="cella1" colspan="2"><textarea name="Note" id="Note" ROWS="4" COLS="80"></textarea></td>
                        </tr>
                        <tr>
