...
//Visualizzo il record che intendo modificare all'interno della form
      ...
      $sql = mysql_query("SELECT * FROM parametro_sing_mac WHERE id_par_sm=" . $IdParametroOld)
              or die("ERRORE 1 SELECT FROM serverdb.parametro_sing_mac: " . mysql_error());
      
      $sql = findParSMById($IdParametroOld);
      ...
      <div id="container" style="width:600px; margin:15px auto;">
        <form id="ModificaParametro" name="ModificaParametro" method="post" action="modifica_parametro_singola2.php">
          <table style="width:600px;">
            <tr>
              <td height="42" colspan="2" class="cella3"><?php echo $titoloPaginaModificaParSm ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="cella1"><input type="text"  name="ValoreBase" id="ValoreBase" value="<?php echo $ValoreBase; ?>" size="40"/></td>
            </tr>
            <tr>
