...
<div id="mainContainer">
  ...
  <div id="container" style="width:600px; margin:15px auto;">
      <form id="InserisciParametro" name="InserisciParametro" method="post" action="carica_parametro_ripristino2.php">
     <table width="600px">
      <tr>
        <td class="cella3" colspan="2"><?php echo $labelNuovoParRipristino?></td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <td class="cella1"><input type="text" name="NomeParametro" id="Nome Parametro" size="40"/></td>
      </tr>
      <tr>
