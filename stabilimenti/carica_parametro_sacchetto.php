  ...
  <body>
    ...
    <div id="mainContainer">
      ...
      <div id="container" style="width:600px; margin:15px auto;">
        <form id="InserisciParametro" name="InserisciParametro" method="post" action="carica_parametro_sacchetto2.php">
          <table width="600px">
            <tr>
              <td class="cella3" colspan="2"><?php echo $labelNuovoParSac?></td>
            </tr>
            <tr>
