...
//      $sql = mysql_query("SELECT * FROM parametro_comp_prod WHERE id_par_comp=" . $IdParametroOld)
//              or die("ERRORE 1 SELECT FROM serverdb.parametro_comp_prod: " . mysql_error());
      
      $sql = findParCompById($IdParametroOld);
      ...
      <div id="container" style="width:600px; margin:15px auto;">
        <form id="ModificaParametro" name="ModificaParametro" method="post" action="modifica_parametro_componente2.php">
          <table style="width:600px;">
            <tr>
              <td height="42" colspan="2" class="cella3"><?php echo $titoloPaginaModificaParComp ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="cella1"><input type="text" name="NomeVariabile" id="NomeVariabile" size="40" value="<?php echo $NomeVariabile; ?>"></input></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="cella1"><input type="text"  name="ValoreBase" id="ValoreBase"  size="40" value="<?php echo $ValoreBase; ?>"></input></td>
            </tr>
            <tr>
