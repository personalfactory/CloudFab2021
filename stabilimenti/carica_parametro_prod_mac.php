...
<div id="mainContainer">
    ...
    <div id="container" style="width:600px; margin:15px auto;">
        <form id="InserisciParametroComp" name="InserisciParametroPM" method="post" action="carica_parametro_prod_mac2.php">
        <table width="600px">
        <tr>
          <td class="cella3" colspan="2"><?php echo $titoloPagNuovoParPm?></td>
        </tr>
        <tr>
