...
<?php if ($TipoRiferimento == 'Continente') { ?>
    <table width="100%">
        ...
        <tr>
            <td  class="cella7">
                <input type="radio" id="scegli_geografico" name="scegli_geografico" onclick="javascript:visualizzaStato();" value="Stato" /><?php echo $filtroStato ?></td>
            <td  bgcolor="#FFFFFF"><div id="Stato" style="visibility:hidden;">
                    <select id="NomeStato" name="Stato">
                        <?php
                        while ($row = mysql_fetch_array($sqlSt)) {
        ...
        <tr>
            <td  class="cella7"><input type="radio" id="scegli_geografico" name="scegli_geografico" onclick="javascript:visualizzaComune();" value="Comune" /><?php echo $filtroComune ?></td>
            <td  bgcolor="#FFFFFF"><div id="Comune" style="visibility:hidden;">
                    <select id="NomeComune" name="Comune">
                        <?php
                        while ($row = mysql_fetch_array($sqlCom)) {
...
<?php if ($TipoRiferimento == 'Comune') { ?>
    <table width="100%">
        ...
        <tr>
            <td  class="cella7">
                <input type="radio" id="scegli_geografico" name="scegli_geografico" onclick="javascript:visualizzaProvincia();" value="Provincia" />
                <?php echo $filtroProvincia ?></td>
            <td  bgcolor="#FFFFFF"><div id="Provincia" style="visibility:hidden;" >
                    <select id="NomeProvincia" name="Provincia">
                        <?php
        ...
        <tr>
            <td  class="cella7">
                <input type="radio" id="scegli_geografico" name="scegli_geografico" onclick="javascript:visualizzaComune();" value="Comune" checked="checked"/>
                <?php echo $filtroComune ?></td>
