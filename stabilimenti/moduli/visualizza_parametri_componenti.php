...
<table class="table3">
    <tr>
        <th colspan="7"><?php echo $titoloPaginaModificaValParComp ?></th>
    </tr>
    <tr>
        <td  colspan="7" style="text-align:center;"> 
            <p><a href="carica_parametro_comp.php"><?php echo $nuovoParametro ?> </a></p>
            <p>&nbsp;</p>
        </td>
    </tr>
    ...
    <form  name="VediParComp" id="VediParComp" action="" method="POST">
        <table class="table3">
            <tr>
                <td><input style="width:100%" type="text" name="IdParComp" value="<?php echo $_SESSION['IdParComp'] ?>" /></td>
            ...
            <tr>              
                <td class="cella3" style="width:<?php echo $widId ?>" ><div id="OrdinaIdPar"><?php echo $filtroIdPar; ?>
                        <button name="Filtro" type="submit" value="id_par_comp" class="button3"  title="<?php echo $titleOrdinaCresc; ?>">
            ...
            while ($row = mysql_fetch_array($sql)) {
                ...
                if ($colore == 1) {
                    ?>
                    <tr>
                        <td class="cella1" style="width:<?php echo $widId ?>"><?php echo($row['id_par_comp']) ?></td>
                        ...
                        <td class="cella1" style="width:<?php echo $widOp ?>">
                            <!--<a href="cancella_parametro_componente.php?Parametro=<?php echo($row['id_par_comp']) ?>"><img src="/CloudFab/images/pittogrammi/patumiera_R.png" class="icone" title="<?php echo $titleElimina ?>"/></a>--> 
                            <a href="modifica_parametro_componente.php?Parametro=<?php echo($row['id_par_comp']) ?>"><img src="/CloudFab/images/pittogrammi/penna_R.png" class="icone" title="<?php echo $titleModifica ?>"/></a>
                        </td>
                    </tr>
                    <?php
                    $colore = 2;
                    ...
                    ?>
                    <tr>
                        <td class="cella2" style="width:<?php echo $widId ?>"><?php echo($row['id_par_comp']) ?></td>
