...
<table class="table3">
    <tr>
        <th colspan="7"><?php echo $titoloPaginaGestioneParSm ?></th>
    </tr>
    <tr>
        <td  colspan="7" style="text-align:center;"> 
            <p><a href="carica_parametro_sing.php"><?php echo $nuovoParametro ?></a></p>
            <p>&nbsp;</p>
        </td>
        <!--################## MOTORE DI RICERCA ###################################-->
    <form  name="VediParSm" id="VediParSm" action="" method="POST">
        <table class="table3">
            <tr>
                <td><input style="width:100%" type="text" name="IdParSm" value="<?php echo $_SESSION['IdParSm'] ?>" /></td>
                ...
                <td><input type="button" value="<?php echo $valueButtonCerca ?>" onClick="document.forms['VediParSm'].submit();"/></td>
            </tr>
            <!--################## ORDINAMENTO ########################################-->
            <tr>              
            ...
            while ($row = mysql_fetch_array($sql)) {
                ...
                if ($colore == 1) {
                    ?>
                    <tr>
                        <td class="cella1" style="width:<?php echo $widId ?>"><?php echo($row['id_par_sm']) ?></td>
                        ...
                        <td class="cella1" style="width:<?php echo $widVal ?>" title="<?php echo $row['valore_variabile'] ?>"><?php echo(substr($row['valore_base'], 0, 30) ).$strFineVal ?></td>
                        ...
                        <td class="cella1" style="width:<?php echo $widOp ?>">
                            <!--<a href="cancella_parametro_singola.php?Parametro=<?php echo($row['id_par_sm']) ?>"><img src="/CloudFab/images/pittogrammi/patumiera_R.png" class="icone" alt="Elimina" title="Clicca per cancellare il parametro"/></a>--> 
                            <a href="modifica_parametro_singola.php?Parametro=<?php echo($row['id_par_sm']) ?>"><img src="/CloudFab/images/pittogrammi/penna_R.png" class="icone" title="<?php echo $titleModifica ?>"/></a>
                        </td>
                    </tr>
                    <?php
                    $colore = 2;
                    ...
                    ?>
                    <tr>
                        <td class="cella2" style="width:<?php echo $widId ?>"><?php echo($row['id_par_sm']) ?></td>
                        ...
                        <td class="cella2" style="width:<?php echo $widVal ?>" title="<?php echo $row['valore_variabile'] ?>"><?php echo(substr($row['valore_base'], 0, 30) ).$strFineVal ?></td>
