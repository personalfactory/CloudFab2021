                ...
                <tr>
                    ...
                    <td class="cella1" style="width:<?php echo $wid7 ?>"><nobr>
                        ...
                        <a name="36" href="gestione_processo.php?IdMacchina=<?php echo($row['id_macchina']) ?>&DescriStab=<?php echo ($row['descri_stab']) ?>&Filtro=id_processo">
                            <img src="/CloudFab/images/pittogrammi/insacco_G.png" class="icone" alt="<?php echo $titleVediProduzione ?>" title="<?php echo $titleVediProduzione ?>"/></a>
                        ...
                        <a name="35" href="/CloudFab/prodotti/vista_prodotti_per_impianto.php?IdMacchina=<?php echo ($row['id_macchina']) ?>&DescriStab=<?php echo ($row['descri_stab']) ?>">
                            <img src="/CloudFab/images/pittogrammi/lente-G.png" class="icone" style="border-radius: 5px 5px 5px 5px" title="<?php echo $titleProdottiAssegnati ?>"/></a>   
                            </nobr>
                    </td>
                </tr>
                <?php
