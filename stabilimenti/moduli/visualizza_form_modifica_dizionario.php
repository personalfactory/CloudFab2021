<?php if ($DizionarioTipo=='CodiceProdotto'){?>	
    <table width="530">
	            <tr>
	            ...
	            <tr>
	              ...
	              <td bgcolor="#FFFFFF"><div id="Prodotto" style="visibility:hidden;">
	                <select id="CodiceProdotto" name="CodiceProdotto">
	                 <option value="<?php echo $IdVocabolo;?>" selected><?php echo $Vocabolo;?></option>
                      <?php 
            ...
            <?php 
}///End if (codiceprodotto) ?>
<?php if ($DizionarioTipo=='NomeComponente'){?>	
    <table width="530">
	            <tr>
	              <td colspan="2"><div id="MSG">Selezionare una tipologia di Dizionario</div></td>
                </tr>
            ...
            <?php 
}//End if(nomecomponente) ?>
<?php if ($DizionarioTipo=='NomeColoreBase'){?>	
    <table width="530">
	            <tr>
	              <td colspan="2"><div id="MSG">Selezionare una tipologia di Dizionario</div></td>
                </tr>
            ...
            <?php 
}///End if (NomecoloreBase) ?>
<?php if ($DizionarioTipo=='MessaggioMacchina'){?>	
    <table width="530">
	            <tr>
	              <td colspan="2"><div id="MSG">Selezionare una tipologia di Dizionario</div></td>
                </tr>
