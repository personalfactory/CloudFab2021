...
<table class="table3">
    <tr>
        <th colspan="7"><?php echo $titoloPaginaParProdotto ?></th>
    </tr>
    <tr>
        <td  colspan="7" style="text-align:center;"> 
            <p><a href="carica_parametro_prodotto.php"><?php echo $nuovoParametro ?></a></p>
            <p>&nbsp;</p>
        </td>
    </tr>
    <!--################## MOTORE DI RICERCA #######################################-->
    <form  name="VediParProd" id="VediParProd" action="" method="POST">
        <table class="table3">
            <tr>
                <td><input style="width:100%" type="text" name="IdParProd" size="10px" value="<?php echo $_SESSION['IdParProd'] ?>" /></td>
                <td><input style="width:100%" type="text" name="NomeVariabile" size="35px" value="<?php echo $_SESSION['NomeVariabile'] ?>" /></td>
                <td><input style="width:100%" type="text" name="DescriVariabile" size="40px" value="<?php echo $_SESSION['DescriVariabile'] ?>" /></td>
                <td><input style="width:100%" type="text" name="Valore" value="<?php echo $_SESSION['Valore'] ?>" /></td>
                <td><input style="width:100%" type="text" name="Abilitato" size="10px" value="<?php echo $_SESSION['Abilitato'] ?>" /></td>
                <td><input style="width:100%"type="text" name="DtAbilitato" value="<?php echo $_SESSION['DtAbilitato'] ?>" /></td>
                <td><input type="button" value="<?php echo $valueButtonCerca ?>" onClick="document.forms['VediParProd'].submit();"/></td>
            </tr>
            <!--################## ORDINAMENTO ########################################-->
            <tr>              
            ...
            while ($row = mysql_fetch_array($sql)) {
                ...
                if (strlen($row['descri_variabile']) > 50) {
                ...
                if ($colore == 1) {
                    ?>
                    <tr>
                        <td class="cella1" style="width:<?php echo $widId ?>"><?php echo($row['id_par_prod']) ?></td>
                        ...
                        <td class="cella1" style="width:<?php echo $widDes ?>" title="<?php echo $row['descri_variabile'] ?>"><?php echo(substr($row['descri_variabile'], 0, 50) . $strFineDes) ?></td>
                        ...
                        <td class="cella1" style="width:<?php echo $widOp ?>">
                            <!--<a href="cancella_parametro_prodotto.php?Parametro=<?php echo($row['id_par_prod']) ?>"><img src="/CloudFab/images/pittogrammi/patumiera_R.png" class="icone" alt="Elimina" title="Clicca per cancellare il parametro"/></a> -->
                            <a href="modifica_parametro_prodotto.php?Parametro=<?php echo($row['id_par_prod']) ?>">
                    ...
                    ?>
                    <tr>
                        <td class="cella2" style="width:<?php echo $widId ?>"><?php echo($row['id_par_prod']) ?></td>
                        ...
                        <td class="cella2" style="width:<?php echo $widDes ?>" title="<?php echo $row['descri_variabile'] ?>"><?php echo(substr($row['descri_variabile'], 0, 50) . $strFineDes) ?></td>
