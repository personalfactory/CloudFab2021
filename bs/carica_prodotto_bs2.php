...
//Inizializzazione dell'errore e del messaggio di errore
            ...
            if ($errore) {
                ...
                if ($ToDo == "NuovoProdotto") {
                    ...
                    $insProdottoBs = updateBSProdottoById($IdProdotto, $Classificazione, $Rating, $LinkPresentazioneProd, $LinkSchedaTecnica, $Features, $Corrispettivo1, $Prezzo1, $Note1, $Corrispettivo2, $Prezzo2, $Note2, $Corrispettivo3, $Prezzo3, $Note3, $IdAzienda);
                }
