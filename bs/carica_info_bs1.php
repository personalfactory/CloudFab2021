    ...
    if ($row['tipo'] == $valBsTipoProdPf) {
        ...
        <?php } ?>
                            ...
                            <td class="<?php echo $classTdRight ?>" width="<?php echo $wid12 ?>"><nobr><input onkeypress="BloccaTastoInvio(event)" type="text" style="text-align:right" name="SacchiVenRivenditore<?php echo ($row['cod_prodotto']); ?>" id="SacchiVenRivenditore<?php echo ($row['cod_prodotto']); ?>" size ="8" value="<?php echo $sacchiVendutiRivenditore ?>" onChange="AggiornaPagina()"/>&nbsp;<span class='uniMisStyle'><?php echo $filtroTonBreve ?></span></td>-->
                             <td class="<?php echo $classTdRight ?>" width="<?php echo $wid30 ?>"><input onkeypress="BloccaTastoInvio(event)" type="text" style="text-align:right" name="GeneratoreListino<?php echo ($row['cod_prodotto']); ?>" id="GeneratoreListino<?php echo ($row['cod_prodotto']); ?>" size ="8" value="<?php echo $generatoreListino ?>" /></td>
                            <td class="<?php echo $classTdRight ?>" width="<?php echo $wid9 ?>"><nobr><?php echo $listinoSuggProdFinitoQ . " <span class='uniMisStyle'>" . $filtroValuta . "</span>" ?></nobr></td>
                            <td class="<?php echo $classTdRight ?>" width="<?php echo $wid10 ?>"><nobr><input onkeypress="BloccaTastoInvio(event)" type="text" style="text-align:right" name="SacchiVenPrivato<?php echo ($row['cod_prodotto']); ?>" id="SacchiVenPrivato<?php echo ($row['cod_prodotto']); ?>" size ="8" value="<?php echo $sacchiVendutiPrivato ?>" />&nbsp;<span class='uniMisStyle'><?php echo $filtroTonBreve ?></span></nobr></td>
                            <td class="<?php echo $classTdRight ?>" width="<?php echo $wid11 ?>"><nobr><input onkeypress="BloccaTastoInvio(event)" type="text" style="text-align:right" name="SacchiVenImpresa<?php echo ($row['cod_prodotto']); ?>" id="SacchiVenImpresa<?php echo ($row['cod_prodotto']); ?>" size ="8" value="<?php echo $sacchiVendutiImpresa ?>"/>&nbsp;<span class='uniMisStyle'><?php echo $filtroTonBreve ?></span></td>
                            <td class="<?php echo $classTdRight ?>" width="<?php echo $wid12 ?>"><nobr><input onkeypress="BloccaTastoInvio(event)" type="text" style="text-align:right" name="SacchiVenRivenditore<?php echo ($row['cod_prodotto']); ?>" id="SacchiVenRivenditore<?php echo ($row['cod_prodotto']); ?>" size ="8" value="<?php echo $sacchiVendutiRivenditore ?>" />&nbsp;<span class='uniMisStyle'><?php echo $filtroTonBreve ?></span></td>
