...
//        }
        ...
        <table class="table3">
          ...
          <tr>
            <td class="cella6">
              ...
              <a href="elimina_bs_dato.php?Conferma=SI&Tabella=<?php echo $Tabella ?>&NomeId=<?php echo $NomeId ?>&IdRecord=<?php echo $IdRecord ?>&RefBack=<?php echo $RefBack ?>">
        ...
        $delete=mysql_query("DELETE FROM " . $Tabella . " WHERE " . $NomeId . "='".$IdRecord."'")
                or die("SCRIPT elimina_bs_dato.php - ERRORE : DELETE FROM " . $Tabella . " WHERE " . $NomeId . "=" . $IdRecord. "" . mysql_error());
