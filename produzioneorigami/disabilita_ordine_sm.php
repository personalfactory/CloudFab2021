                ...
                <table class="table3">
                    ...
                    <tr>
                        <td class="cella6">
                            ...
                            <a id="Conferma" href="disabilita_ordine_sm.php?Conferma=SI&Tabella=<?php echo $Tabella ?>&idOrdine=<?php echo $idOrdine ?>&idOrdineSm=<?php echo $idOrdineSm ?>&RefBack=<?php echo $RefBack ?>">
...
//        $sql = mysql_query("UPDATE " . $Tabella . " SET abilitato=0 WHERE id_prodotto=" . $idOrdineSm)
//                or die("ERRORE 2 : UPDATE serverdb." . $Tabella . "" . mysql_error());
            $disabilita = true;
            begin();
            $disabilita = modificaAbilitatoOrdineSm($idOrdineSm,$valDisabilitato);
