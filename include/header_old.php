...
<link rel="stylesheet" type="text/css" href='/CloudFab/css/styleAdmin.css'/>
...
if (isset($_SESSION['username'])) {
    ...
    <h1> 
        ...
        <div>
            ...
            <a href="http://www.personalfactory.eu/configuratore/login.php" target="blank" title="<?php echo $titleLinkConfiguratore ?>"><img src="/CloudFab/images/linkConfiguratore.png" style="align:end; width:38px;height:60px;padding-right:20px;border:0"/></a>  
