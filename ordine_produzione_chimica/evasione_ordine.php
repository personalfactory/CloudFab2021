...
<html>
    ...
    <head>
		...
		function registraEvasioneOrdine() {
			...
			dati_evasione.push(document.getElementById('noteOrdine').value);  
	...
	<body onload="aggiungiRiga()">
        ...
        <table width="100%" class="table2" id= "dati_odine">
			<tr>
				<td class="cella3" colspan="4" style="font-size: 14px;" id="rep";><?php echo $titleDettaglEvadiOrdine; ?></td>
			</tr> 
			<tr> 
			...
			<tr> 
				<th class="cella2" colspan="1" style="font-size: 12px; width:100%; "><?php echo $titleDettagliEvasioneResponsabile; ?> </th>
