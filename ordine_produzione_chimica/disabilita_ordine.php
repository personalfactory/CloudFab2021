...
<html>
	...
	<body onload="aggiungiRiga()">
        ...
        <table width="100%" class="table2" id= "dati_odine">
			<tr>
				<td class="cella3" colspan="5" style="font-size: 14px;" id="rep";><?php echo $titleDettaglDisabilitaOrdine; ?></td>
			</tr> 
			<tr> 
			...
			<tr>
				<td class="cella3" colspan="5" style="font-size: 14px;" id="rep";><?php echo $titleDettagliAbilitaDisabilitaResponsabile; ?></td>
			</tr> 
			...
			<tr> 
				<th class="cella2" colspan="1" style="font-size: 12px; "><?php echo $titleDettagliAbilitaDisabilitaResponsabile; ?> </th>
