                                        ...
                                        <td class="cella1" width="100px"> 
                                            <table  width="100%">
                                                ...
                                                while ($rowRisCar = mysql_fetch_array($sqlRisCar)) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td  title="<?php echo $rowRisCar['valore_caratteristica'] . " " . $rowRisCar['uni_mis_car'] . " " . $rowListaCar['note'] ?>"><?php echo substr($rowRisCar['valore_caratteristica'], 0, $numCarVis) . $TrePunti . " <span class='uniMisStyle'>" . $rowRisCar['uni_mis_car'] . "</span>" ?></td> 
                                                        <?php if ($rowRisCar['valore_dimensione'] != 0) { ?>
                                                            <td  title="<?php echo $rowRisCar['valore_caratteristica'] . " " . $rowRisCar['uni_mis_car'] . " " . $rowListaCar['note'] ?>"><?php echo $rowRisCar['valore_dimensione'] . " <span class='uniMisStyle'>" . $rowRisCar['uni_mis_dim'] . "</span>" ?></td> 
                                                        <?php } ?>
                                                        <!--</tr>-->
                                                        <?php
