                    ...
                    //##############################################################################
                     if(mysql_num_rows($sqlMatPri)>0){?>
                        ...
                        while ($rowMatPri = mysql_fetch_array($sqlMatPri)) {
                            ...
                            ?>		
                            <tr >
                                <td width="300px" class="cella4"><?php echo $DescriMateria; ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($rowMatPri['prezzo'], $PrecisioneCosti, '.', '') . " " . $filtroLabEuro; ?></td>
                                <td class="cella1"><?php echo number_format($QuantitaPerc, $PrecisioneQta, '.', '') . " " . $filtroLabPerc; ?></td>
                                <td class="cella1"><?php echo number_format($QuantitaPercReale, $PrecisioneQta, '.', '') . " " . $filtroLabPerc; ?></td>
                                <td class="cella1"><?php echo $rowMatPri['qta_reale'] . " " . $filtroLabGrammo ?></td>
                                <td class="cella1"><?php echo number_format($qtaPer100Kg, $Prec100Kg, '.', '') . " " . $filtroLabGrammo ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($costoPerQtaPer100Kg, $Prec100Kg, '.', '') . " " . $filtroLabEuro; ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($CostoPercentuale, $PrecisioneCosti, '.', '') . " " . $filtroLabPerc; ?></td>

                            </tr>
                        <?php }//End While materie prime   ?>
...
//####################  COSTO   ####################
                            ...
                            ?>		
                            <tr >
                                <td width="300px" class="cella4"><?php echo $DescriComp; ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($rowComp['prezzo'], $PrecisioneCosti, '.', '') . " " . $filtroLabEuro; ?></td>
                                <td class="cella1"><?php echo number_format($QuantitaPerc, $PrecisioneQta, '.', '') . " " . $filtroLabPerc; ?></td>
                                <td class="cella1"><?php echo number_format($QuantitaPercReale, $PrecisioneQta, '.', '') . " " . $filtroLabPerc; ?></td>
                                <td class="cella1"><?php echo $rowComp['qta_reale'] . " " . $filtroLabGrammo; ?></td>
                                <td class="cella1"><?php echo number_format($qtaPer100Kg, $Prec100Kg, '.', '') . " " . $filtroLabGrammo; ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($costoPerQtaPer100Kg, $Prec100Kg, '.', '') . " " . $filtroLabEuro; ?></td>
                                <td class="cella1" width="100px"><?php echo number_format($CostoPercentuale, $PrecisioneCosti, '.', '') . " " . $filtroLabPerc; ?></td>
                            </tr>
...
//############# Totali quantità delle materie prime #############
                        ...
                        <tr>
                            <td width="300px" class="cella2" colspan="2"><?php echo $filtroLabTotale ?></td>
                            <td class="cella2"><?php echo number_format($QuantitaPercTot, $PrecTotali, '.', '') . " " . $filtroLabPerc; ?></td>
                            <td class="cella2"><?php echo number_format($QuantitaPercTotReale, $PrecTotali, '.', '') . " " . $filtroLabPerc; ?></td>
                            <td class="cella2"><?php echo number_Format($QuantitaRealeTot, $PrecTotali, '.', '') . " " . $filtroLabGrammo; ?></td>
                            <td class="cella2"><?php echo number_Format($Quantita100kgTot, $PrecTotali, '.', '') . " " . $filtroLabGrammo; ?></td>
                            <td class="cella2" width="100px"><?php echo number_format($CostoTotale, $PrecTotali, '.', '') . " " . $filtroLabEuro; ?></td>
                            <td class="cella2" width="100px"><?php echo number_format($CostoTotalePercentuale, $PrecTotali, '.', '') . " " . $filtroLabPerc; ?></td>
