...
//############## VERIFICA ESISTENZA ############################################
            ...
            if ($errore) {
                ...
                $updateCaratteristica=  modificaCaratteristicaMt($IdCaratteristica,
                        $Caratteristica, 
                        $Descrizione, 
                        $UniMisCar, 
                        $TipoDato, 
                ...
                if(!$updateCaratteristica){
                    rollback();
                    echo $msgErroreVerificato.'<a href="gestione_lab_caratteristiche_mt.php">'.$msgErrContactAdmin.'</a><br/>';
                } else {
                    commit();
                echo $msgInserimentoCompletato.'<a href="gestione_lab_caratteristiche_mt.php">'.$msgOk.'</a><br/>';
                }
