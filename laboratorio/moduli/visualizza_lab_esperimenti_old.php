    ...
    <table class="table3">
        ...
        <tr>      
            ...
            <td><select  style="width:100%" name="CodBarreList" id="CodBarreList" onChange="document.forms['VediLabProve'].submit();">
                ...
                <td><input type="button" value="<?php echo $valueButtonCerca ?>" onClick="document.forms['VediLabProve'].submit();"/></td>
          </tr>
<!-- ################## ORDINAMENTO ######################################## -->
        <tr>
            <td class="cella3" width="<?php echo $wid1 ?>"><div id="OrdinaCodice"><?php  echo $filtroLabFormula; ?>
        ...
        <tr height="30px">
            ...
            <td class="cella1" width="<?php echo $wid4 ?>"><?php echo($row['cod_barre'])?></td>
        ...
        <tr height="30px">
            ...
            <td class="cella2" width="<?php echo $wid4 ?>"><?php echo($row['cod_barre'])?></td>
