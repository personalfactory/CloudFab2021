...
<table class="table3">
    ...
    <tr>
        <td  colspan="6" style="text-align:center;"> 
            <a name="32" href="carica_lab_materia.php"><?php echo $nuovaLabMatPrima ?></a>
        </td>
    </tr>
</table>
    <!--################## MOTORE DI RICERCA ###################################-->
        ...
        if ($colore == 1) {
            ...
            <tr>
                ...
                <td class="cella1" width="<?php echo $wid7 ?>">
                    ...
                    <a href="genera_cod_barre.php?CodMat=<?php echo $row['cod_mat'] ?>&NomeMat=<?php echo $row['descri_materia']?>">
