...
//#################### RISULTATI TESTO ###########################
                        ...
                        if ($rowListaCar['tipo_dato'] == $valCarTxt) {
                            ...
                            if (isSet($_POST['RisTxt' .$rowListaCar['id_carat']])) {
                                
                               //Array contenente tutti i risultati testo selezionati per una singola caratteristica 
                               $risCarTxtScelti= $_POST['RisTxt' . $rowListaCar['id_carat']];
                                
                              
                                $numRisScelti = count($risCarTxtScelti);

                                for ($i = 0; $i < $numRisScelti; $i++) {
                                    $IdEsper = "";
                                    $IdCarat = "";
                                    $ValoreCar = "";
                                    $Note = "";
                                    $strindValoreTxt = "";
                                    $stringValoreNote = "";
                                    list($IdEsper[$i], $IdCarat[$i], $ValoreCar[$i], $Note[$i]) = explode(";", $risCarTxtScelti[$i]);
                                    ...
                                    echo "<div style='background:#CCFF99'></br>caratteristica= " . $countRisTxt .
