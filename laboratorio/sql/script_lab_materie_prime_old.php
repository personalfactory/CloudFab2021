...
function selectLabMatPrimeByFiltri($campoOrdine,
        ...
        $fornitore,$dtAbilitato,$strUtentiAziende) {
...
function updateMateriaPrima($idMateria,$sottoTipo,$famiglia,$descri,$note,$fornitore,$prezzo,$unitaMisura,$idAzienda){
 ...
 * @param type $prezzo
 * @param type $prezzoGrammi
 * @param type $fornitore
 * @param type $note
 * @param type $idUtente
 * @param type $idAzienda
 */
function insertMateriaPrima($famiglia,$sottoTipo,$codice,$nome,$data,$unitaMisura,$prezzo,$fornitore,$note,$idUtente,$idAzienda){
 
    $sql=   mysql_query("INSERT INTO serverdb.lab_materie_prime 
        (famiglia,tipo,cod_mat,descri_materia,dt_abilitato,unita_misura,prezzo,fornitore,note,id_utente,id_azienda)
                VALUES ('" . $famiglia . "',
                        '" . $sottoTipo . "',
                        '" . $codice . "',
                        '" . $nome . "',
                        ...
                        " . $idUtente . ",
                        " . $idAzienda . ")"); 
//     or  die("ERROR IN script_lab_materie_prime - FUNCTION insertMateriaPrima - INSERT INTO serverdb.lab_materie_prime  : " . mysql_error());
    return $sql;
}
