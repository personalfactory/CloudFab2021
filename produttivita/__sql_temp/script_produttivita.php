...
//
//    mysql_query("DELETE FROM produttivita WHERE id_utente=" . $idUtente) or die("ERROR IN script_produttivita- FUNCTION deleteFromProduttivitaByUtente - DELETE FROM produttivita WHERE id_utente : " . mysql_error());
//}
...
//
//    mysql_query("UPDATE produttivita SET in_servizio = 1 WHERE diff<" . $SecondiDaEscludere . " AND id_utente=" . $idUtente) or die("ERROR IN script_produttivita- FUNCTION updateTempInServizio - UPDATE produttivita.in_servizio : " . mysql_error());
//}
...
//
//    mysql_query("UPDATE produttivita SET attivo = 1 WHERE diff<" . $SecondiInattivita . "  AND id_utente=" . $idUtente) or die("ERROR IN script_produttivita - FUNCTION updateTempAttivo - UPDATE serverdb.produttivita.attivo : " . mysql_error());
//}
...
//
//    $sql = mysql_query("SELECT SUM(diff) AS num_sec_in_servizio FROM produttivita WHERE in_servizio=1 AND id_utente=" . $idUtente) or die("ERROR IN script_produttivita - FUNCTION  selectSecInServizioFromTemp - SELECT FROM serverdb.produttivita : " . mysql_error());
//    return $sql;
//}
...
//
//    $sql = mysql_query("SELECT SUM(diff) AS num_sec_inat FROM produttivita WHERE attivo=0 AND in_servizio=1 AND id_utente=" . $idUtente) or die("ERROR IN script_produttivita - FUNCTION selectSecInatFromTemp - SELECT FROM produttivita : " . mysql_error());
//    return $sql;
//}
...
//
//    $sql = mysql_query("SELECT SUM(diff) AS num_sec_prod FROM produttivita WHERE attivo=1 AND in_servizio=1 AND id_utente=" . $idUtente) or die("ERROR IN script_produttivita - FUNCTION selectSecProdFromTemp - SELECT FROM produttivita : " . mysql_error());
//    return $sql;
//}
...
//
//    $sql = mysql_query("SELECT count(id_processo) as num_sac FROM serverdb.produttivita WHERE id_utente=" . $idUtente) or die("ERROR IN script_produttivita - FUNCTION selectNumSacFromTemp - SELECT * FROM serverdb.produttivita: " . mysql_error());
//    return $sql;
//}
...
//        }
    ...
    $string.=")             AND    
                        ...
                        ORDER BY " . $filtro;
//    echo $string;
    $sql = mysql_query($string) or die("ERROR IN script_produttivita - FUNCTION selectProcessiTempByFiltri - SELECT * FROM produttivita: " . mysql_error());
 ...
 * @return type
 */
function selectProcessiTempByFiltri2($idMacchina, $dataTo, $dataFrom, $inServizio, $attivo, $idProcesso, $codProdotto, $codChimica, $codSacco, $nominativo, $att, $prec, $nomeProdotto, $descriStab, $idUtente, $filtro) {
    ...
    $sql = mysql_query("SELECT
                        ...
                        WHERE 
                            ...
                            AND
                                m.descri_stab LIKE '%" . $descriStab . "%' 
                        ORDER BY " . $filtro) or die("ERROR IN script_produttivita - FUNCTION selectProcessiTempByFiltri2 - SELECT * FROM produttivita: " . mysql_error());
...
$dataTo, $dataFrom, $inServizio, $attivo, $idProcesso, $codProdotto, $codChimica, $codSacco, $nominativo, $att, $prec, $nomeProdotto, $descriStab, $idUtente, $filtro) {
    ...
    $sql = mysql_query("SELECT
                        ...
                        WHERE 
                            ...
                            AND
                                m.descri_stab LIKE '%" . $descriStab . "%' 
                        ORDER BY " . $filtro) or die("ERROR IN script_produttivita - FUNCTION selectProcessiTempAllByFiltri - SELECT * FROM produttivita: " . mysql_error());
...
function selectCreateProduttivita($Data3, $Data4, $CodOperatore, $CodProdotto, $stabGrupGeo) {
...
//          echo $string;
    $sql = mysql_query($string) or die("ERROR IN script_produttivita - FUNCTION selectCreateProduttivita - SELECT * FROM processo: " . mysql_error());
    return $sql;
}