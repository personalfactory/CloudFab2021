...
//Se la giacenza è inferiore alla qta richiesta stampo la qta necessaria 
        if ($giacenzaMat < $qtaTotMatOrdine[$j]) {
            ...
            ?>
                                <tr>
                                    ...
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo number_format($costoMateria, "2", ",", ".") . " " . $filtroEuro ?></nobr></td>
                                    ...
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo $scortaMinima . " " . $filtroKgBreve ?></nobr></td>
                                </tr>
        <?php } else { ?>
                                <tr><td class="cella2" style='color:#008000;'><?php echo $arrayMat[$j] . " " . $descriMateria ?></td>
                                    ...
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo number_format($costoMateria, "2", ",", ".") . " " . $filtroEuro ?></nobr></td>
                                    ...
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo $scortaMinima . " " . $filtroKgBreve ?></nobr></td>
                                </tr>
        <?php } ?>
    ...
    <?php } ?>
                        <tr>
                            ...
                            <td class="dataRigWhite" style='text-align: right'><?php echo number_format($totCostoMaterie, "2", ",", ".") . " " . $filtroEuro ?></td>
                            <td class="dataRigWhite" ></td>
                            <td class="dataRigWhite" ></td>
                             <td class="dataRigWhite" ></td>
                        </tr>
    ...
    ?>
                    ...
                    <br/>
                     <table width="100%">
                        <th colspan="7">PRODUZIONE ORDINE VISTA LA GIACENZA DEI LOTTI</th>
                        <tr>
                            <td class="cella2" width="30%">MATERIE PRIME</td> 
                            <td class="cella2" width="10%">GIACENZA</td> 
                            <td class="cella2" width="10%">QUANTITÀ<br/>NECESSARIA</td>
...
//            $giacenzaMat = $row['giacenza_attuale'];
        ...
        $costoMateria=  $qtaTotMat[$j]*$costoKg;
        $totCostoMaterie=$totCostoMaterie+$costoMateria;
        $totQtaMat=$totQtaMat+$qtaTotMat[$j];
...
//Se la giacenza è inferiore alla qta richiesta stampo la qta necessaria 
        if ($giacenzaMat < $qtaTotMat[$j]) {
            ...
            ?>
                                <tr>
                                    <td class="cella2" style='color:#A00028;'><?php echo $arrayMat[$j] . " " . $descriMateria ?></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo number_format($giacenzaMat, "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo $qtaTotMat[$j] . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo number_format($costoMateria, "2", ",", ".") . " " . $filtroEuro ?></nobr></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo number_format(($qtaTotMat[$j] - $giacenzaMat), "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo number_format(($giacenzaMat - $qtaTotMat[$j]), "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#A00028;text-align: right'><nobr><?php echo $scortaMinima . " " . $filtroKgBreve ?></nobr></td>
                                </tr>
        <?php } else { ?>
                                <tr><td class="cella2" style='color:#008000;'><?php echo $arrayMat[$j] . " " . $descriMateria ?></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo number_format($giacenzaMat, "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo number_format($qtaTotMat[$j], "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo number_format($costoMateria, "2", ",", ".") . " " . $filtroEuro ?></nobr></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo "0 " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo number_format(($giacenzaMat - $qtaTotMat[$j]), "2", ",", ".") . " " . $filtroKgBreve ?></nobr></td>
                                    <td class="cella2" style='color:#008000;text-align: right'><nobr><?php echo $scortaMinima . " " . $filtroKgBreve ?></nobr></td>
                                </tr>
        <?php } ?>
    ...
    <?php } ?>
                    ...
                    <table>
                        ...
                        <?php
                        if (!$ordineEvaso)
                            echo "<br/><span style='font-size:20px;color:#A00028;'><br/>L' ordine non può essere evaso : materie prime insufficienti!";
                        else
                            echo "<br/><span style='font-size:20px;color:#008000;'><br/>L' ordine può essere evaso considerando le scatole in giacenza</span>";
                        ?></td>
                        </tr>
                    </table>
