...
//    echo "Hai selezionato Procedura: $key con valore: $value<br />"; 
            ...
            if (isset($_POST['Prezzo']) AND trim($_POST['Prezzo']) != "") {
            ...
            if ($errore) {
                ...
                $updateMovMagazzino = true;
                $aggGiacenza = true;

                begin();

                $updateMovMagazzino = modificaMovimento($IdMov, $Operazione, $Causale, $TipoDoc, $NumDoc, $DesDoc, $DtDoc, $Clfoco, $Artico, $DescriArtico,$Quantita, $Prezzo, $Fornitore, $CodArticoForn, $valUniMisKg, $DtArrivoMerce, $MerceConforme, $StabilitaConforme, $ProceduraAdottata, $Operatore, $RespProduzione, $RespQualita, $ConsTecnico, $Note, $destNomeFileDdt);
                ...
                $aggGiacenza = aggiornaGiacMatPrima($Artico, $Fornitore, $GiacenzaAttuale);
                
                if (!$updateMovMagazzino OR !$aggGiacenza) {
