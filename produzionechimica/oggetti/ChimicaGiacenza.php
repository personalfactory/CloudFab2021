...
class ChimicaGiacenza {
    ...
    private $valoreAcquisti;  // double
    private $valoreConsumi;  // double

    function __construct($artico, $descri_artico, $inventario, $dt_inventario, $giacenzaIni, $consumi, $acquisti, $giacenzaFin, $prezzo, $valorizzazione,$valoreAcquisti,$valoreConsumi) {
        $this->artico = $artico;
        ...
        $this->valoreAcquisti = $valoreAcquisti;
        $this->valoreConsumi = $valoreConsumi;
    }
    ...
    function getValoreAcquisti() {
        return $this->valoreAcquisti;
    }

    function getValoreConsumi() {
        return $this->valoreConsumi;
    }

    function setValoreAcquisti($valoreAcquisti) {
        $this->valoreAcquisti = $valoreAcquisti;
    }

    function setValoreConsumi($valoreConsumi) {
        $this->valoreConsumi = $valoreConsumi;
    }
