...
//                print_r($arrayCapMat);
                ...
                <?php if ($row['catalogo'] == $valCatalogoSi) {
                    ...
                    ?>                       
                            <input type="checkbox" name='catalogo<?php echo $i ?>' value='si' checked='' title="<?php echo $nomeTitle ?>"/>
                            <?php
                        } else {
                            ?>
                            <input type="checkbox" name='catalogo<?php echo $i ?>' value='no' title="<?php echo $nomeTitle ?>"/>
                            <?php }
                        ?>
                    ...
                    <td class="<?php echo $nomeClasse; ?>" width="<?php echo $wid5 ?>"><input class="<?php echo $nomeClasse; ?>" style="width:70%;text-align:right" type="text" name="QtaList<?php echo($i); ?>" id="QtaList<?php echo($i); ?>" value="<?php echo number_format($row['listino'], 2, '.', '') ?>" ><?php echo $filtroEuro ?></td>
                    ...
                    <td class="<?php echo $nomeClasse; ?>" width="<?php echo $wid6 ?>"><input  class="<?php echo $nomeClasse; ?>" style="width:60%;text-align:right" type="text" name="QtaInv<?php echo($i); ?>" id="QtaInv<?php echo($i); ?>" value="<?php echo $row['giacenza_attuale'] ?>" ><?php echo $row['uni_mis'] ?></td>
                    <td class="<?php echo $nomeClasse; ?>" width="<?php echo $wid7 ?>"><input  class="<?php echo $nomeClasse; ?>" style="width:60%;text-align:right" type="text" name="QtaScorta<?php echo($i); ?>" id="QtaScorta<?php echo($i); ?>" value="<?php echo $row['scorta_minima'] ?>" ><?php echo $filtroPz ?></td>
