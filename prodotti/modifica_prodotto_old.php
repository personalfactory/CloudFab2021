                ...
                <div id="container" style="width:1200px; margin:15px auto;">
                    <form id="ModificaProdotto" name="ModificaProdotto" method="post" >
                        <table width="100%" >
                            ...
                            <tr>
                                <td width="183px" class="cella4"><?php echo $filtroCodice . " " . $filtroProdotto ?></td>
                                <td width="535px" class="cella1"><input name="CodiceProdotto" type="hidden" id="CodiceProdotto" maxlength="5" 
                        ...
                        <table width="100%">
                            <tr>
                                <td width="300px" class="cella3"><?php echo $filtroComponente ?></td>
...
//                                            findMatPrimaByCodice($rowComponente['cod_componente']);
                                    ...
                                    <td class="cella1"><input size="8px" type="text" name="Fluidificazione<?php echo($NComp); ?>" id="Fluidificazione<?php echo($NComp); ?>" value="<?php echo($rowComponente['valore_residuo_fluidificazione']); ?>" /></td>
                                    ...
                                    <td class="cella1"><input size="3px" type="text" name="CompAbilitato<?php echo($NComp); ?>" id="CompAbilitato<?php echo($NComp); ?>"  value="<?php echo($rowComponente['comp_abilitato']); ?>"/></td>
                                    <td class="cella1">
                                        <a name="SostituisciComp" href="sostituisci_componente_prodotto.php?IdComponente=<?php echo($rowComponente['id_comp']); ?>&IdProdotto=<?php echo $IdProdotto ?>">
                            ...
                            <table width="100%" >
                                ...
                                <tr> 
                                    <td class="cella2"  style="text-align: right " colspan="6">
                                        ...
                                        <input type="button" id="Aggiungi" name="Aggiungi" onClick="location.href = 'aggiungi_componente_prodotto.php?IdProdotto=<?php echo $IdProdotto; ?>'" title="<?php echo $titleAggiungiComp ?>"  value="<?php echo $valueButtonAggiungiComp ?>" />
...
//Inizializzo la variabile errore relativa ai campi delle tabelle prodotto e anagrafe_prodotto
        ...
        <?php include('../include/menu.php'); ?>
                            <div id="container" style="width:1100px; margin:15px auto;">
                                <form id="ModificaProdotto" name="ModificaProdotto" method="post" >
                                    <table width="100%" >
                                        <tr>
                                        ...
                                        <tr>
                                            <td width="183" class="cella4"><?php echo $filtroCodice . " " . $filtroProdotto ?></td>
        ...
        while ($rowComponente = mysql_fetch_array($sqlComponente)) {
            ...
            ?>
                                    ...
                                    <td class="cella1"><input style="width:40px"type="text"  name="CompAbilitato<?php echo($NComp); ?>" id="CompAbilitato<?php echo($NComp); ?>" value="<?php echo $_POST['CompAbilitato' . $NComp]; ?>" /></td>
                                    <td class="cella1">
                                        <a name="SostituisciComp" href="sostituisci_componente_prodotto.php?IdComponente=<?php echo($rowComponente['id_comp']); ?>&IdProdotto=<?php echo $IdProdotto ?>">
                                            <img src="/CloudFab/images/pittogrammi/componenti_R.png" class="icone" title="<?php echo $titleSostituisciComp ?>"/></a>  
                                      <!--  <a name="DisabilitaComp" href="disabilita_record.php?Tabella=componente_prodotto&IdRecord=<?php echo $rowComponente['id_comp_prod'] ?>&RefBack=modifica_prodotto.php?Prodotto=<?php echo $IdProdotto ?>">
        ...
        ?>
                                            <tr> 
                                                <td class="cella2"  style="text-align: right " colspan="6">
                                                    ...
                                                    <input type="button" id="Aggiungi" name="Aggiungi" value="<?php echo $valueButtonAggiungiComp ?>" title="<?php echo $titleAggiungiComp ?>"   onClick="location.href = 'aggiungi_componente_prodotto.php?IdProdotto=<?php echo $IdProdotto; ?>'"/>
                                <!--                    <input type="button" onclick="javascript:Duplica();" value="DUPLICA" />-->
