...
<div id="container" style="width:500px; margin:50px auto;">
    ...
    <tr>
        ...
        <tr>
    	<td class="cella2"><?php echo $filtroQuartoLivello ?> </td><td class="cella1"><input type="text" name="QuartoLivello" id="QuartoLivello" placeholder="<?php echo $valDefaultLivello4 ?>"/></td>
    </tr>
    <tr>
    	<td class="cella2"><?php echo $filtroQuintoLivello ?> </td><td class="cella1"><input type="text" name="QuintoLivello" id="QuintoLivello" placeholder="<?php echo $valDefaultLivello5 ?>"/></td>
    </tr>
    <tr>
        <td class="cella2"><?php echo $filtroSestoLivello ?> </td><td class="cella1"><input type="text" name="SestoLivello" id="SestoLivello" placeholder="<?php echo $valDefaultLivello6 ?>"/></td>
    </tr>
        <tr>
