...
<html>
    ...
    <script language="javascript">
        function Modifica() {
            document.forms["ModificaProdotto"].action = "modifica_colore_new2.php";
            document.forms["ModificaProdotto"].submit();
        }
        function AggiornaCalcoli() {
            document.forms["ModificaProdotto"].action = "modifica_colore_new.php";
            document.forms["ModificaProdotto"].submit();
        }
                ...
                <div id="container" style="width:1300px; margin:15px auto;">
                    <form id="ModificaProdotto" name="ModificaProdotto" method="post" >
                        <table width="100%" >
                            ...
                            <tr>
                                <td  colspan="9"  class="cella1" style="text-align: center"><b><?php echo $titoloModColor ?></b></td>
                            </tr>
                            <tr>
                                            ...
                                            <td class="cella4">
                                                ...
                                                <div id="SerieEsistente" >
                                                    <select id="SerieEs" name="SerieEs">
                                                        ...
                                                        <?php while ($rowSerieColori = mysql_fetch_array($sqlSerieColore)) { ?>
                                                            <option value="<?php echo($rowSerieColori['serie_colore']) ?>"><?php echo($rowSerieColori['serie_colore']) ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </td>
                        ...
                        <table width="100%">
                            <tr>
                                <td class="cella1" width="400px"><?php echo $filtroPigmenti ?></td>
                                           ...
                                           <!-- <a name="ComponentiAlternativi" href="definisci_componenti_alternativi.php?IdComponente=<?php echo($rowComponente['id_comp']); ?>&IdProdotto=<?php echo $IdProdotto ?>&NomeProd=<?php echo $NomeProdotto ?>">
                                                <img src="/CloudFab/images/pittogrammi/componenti_G.png" class="icone" title="<?php echo $titleDefinisciCompAlternativi ?>"/></a>  	 -->
                                                      ...
                                                      <!-- <a name="DisabilitaComp" href="disabilita_record.php?Tabella=componente_prodotto&IdRecord=<?php echo $rowComponente['id_comp_prod'] ?>&RefBack=modifica_prodotto.php?Prodotto=<?php echo $IdProdotto ?>">
                                                            <img src="/CloudFab/images/pittogrammi/patumiera_G.png" class="icone"  title="<?php echo $titleDisabilitaComp ?>"/></a>	  -->    
                                    </td>
                                </tr>
                                <?php
                                $NComp++;
                    ...
                    ##############################################################################-->
                            ...
                            <tr> 
                                <td class="cella2"  style="text-align: right " colspan="6">
                                    ...
                                    <input type="button" id="Aggiungi" name="Aggiungi" onClick="location.href = 'aggiungi_componente_prodotto.php?IdProdotto=<?php echo $IdProdotto; ?>&TipoMateriale=2'" title="<?php echo $titleAggiungiComp ?>"  value="<?php echo $valueButtonAggiungiPigmento ?>" />
...
//          $Gruppo = $_POST['SestoLivello'];
                ...
                if (isset($_POST['scegli_serie'])) {
                    ...
                    if ($scegliSerie == "SerieEs") {
                        $serieColore = $_POST['SerieEs'];
                    } else if ($scegliSerie == "SerieNu") {
                        $serieColore = str_replace("'", "''", $_POST['SerieNu']);
                    }
                }
                        ...
                        <div id="mainContainer">
                            ...
                            <div id="container" style="width:1300px; margin:15px auto;">
                                <form id="ModificaProdotto" name="ModificaProdotto" method="post" >
                                    <table width="100%" >
                                        <tr>
                                            <td  colspan="2" class="cella1" style="text-align: center"><b><?php echo $titoloModColor ?></b></td>
                                        </tr>
                                        <input type="hidden" name="IdUtenteProp" id="IdUtenteProp" value="<?php echo $IdUtenteProp; ?>"></input>
                                        <input type="hidden" name="IdProdotto" id="IdProdotto" value=<?php echo $IdProdotto; ?>></input>
    ...
    <?php } else if ($scegliSerie == 'SerieNu') { ?>
        ...
        <?php } ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cella4"  >
                                                    <div id="SerieNuova" >
                                                        <input type="text" name="SerieNu" id="SerieNu" size="50" style="text-transform: uppercase;" value="<?php echo $serieColore ?>"/>
                    ...
                    ##########################################################################-->
                                        ...
                                        <tr> 
                                            <td class="cella2"  style="text-align: right " colspan="6">
                                                ...
                                                <input type="button" id="Aggiungi" name="Aggiungi" value="<?php echo $valueButtonAggiungiPigmento ?>"   onClick="location.href = 'aggiungi_componente_prodotto.php?IdProdotto=<?php echo $IdProdotto; ?>TipoMateriale=2'"/>
