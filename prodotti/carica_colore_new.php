...
<html>
    ...
    <script language="javascript">
        function Carica() {
            document.forms["InserisciProdotto"].action = "carica_colore_new2.php";
            document.forms["InserisciProdotto"].submit();
        }
        function AggiornaCalcoli() {
            document.forms["InserisciProdotto"].action = "carica_colore_new.php";
            document.forms["InserisciProdotto"].submit();
        }
    ...
    <body onLoad="<?php echo $actionOnLoad ?>">
        <div id="mainContainer">
            ...
            $sqlComponente = selectCompVisByDizionarioAndTipo2($strUtentiAziendeComp, "descri_componente", $_SESSION['lingua'], $valTipo2Pigment);
            commit();
...
//TODO: gestire codice famiglia
                $codiceFamiglia = $valFamigliaColoreDefault;
...
//#################### FINE GENERAZIONE CODICE FORMULA #########################
                ...
                <div id="container" style="width:1300px; margin:15px auto;">
                    <form id="InserisciProdotto" name="InserisciProdotto" method="post" >
                        <table width="100%" >
                            <tr>
                                <td  colspan="6" class="cella1" style="text-align: center"><b><?php echo $titoloNewColor ?></b></td>
                            </tr>
                            <tr>
