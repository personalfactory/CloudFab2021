...
<html>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Carica() {
            ...
            var r = confirm(" <?= $msgConfirmDuplicaCategoria ?> ");
            if (r == true) {
                document.forms["DuplicaCategoria"].action = "duplica_categoria2.php";
                document.forms["DuplicaCategoria"].submit();
        ...
        <body onLoad="<?php echo $actionOnLoad ?>">         
            <div id="mainContainer">
                ...
                <div id="container" style="width:60%; margin:15px auto;">
                    <form id="DuplicaCategoria" name="DuplicaCategoria" method="post" >
                        <table style="width:100%;">
                            <input type="hidden" name="IdCategoria" id="IdCategoria" value="<?php echo $IdCategoria; ?>"></input>
                            <tr>
                                <th colspan="2" class="cella3"><?php echo $titoloPaginaDuplicaCat ?></th>
                            </tr>
                            <tr>
                                <td colspan="2" class="cella2"><?php echo $filtroDuplicaCat . $NomeCategoria ?></th>
                            </tr>
                            <tr>
                                <td class="cella2"><?php echo $filtroNome ?></td>
                                <td class="cella1"><textarea type="text" name="NomeCategoria" id="NomeCategoria" ROWS="1" COLS="40" ></textarea></td>
                            </tr>
                            <tr>
                                <td class="cella2"><?php echo $filtroDescrizione ?></td>
                                <td class="cella1">
                                    <textarea name="DescriCategoria" id="DescriCategoria" ROWS="4" COLS="40" ></textarea>
                                </td>
                            </tr>
                            <tr>
                            ...
                            while ($rowSac = mysql_fetch_array($sqlSac)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table width="100%">
                                            <td class="cella1"><?php echo ($rowSac['num_sacchetti']); ?>
                                                <input type="hidden" name="Soluzione<?php echo $NSac; ?>" id="Soluzione<?php echo $NSac; ?>" value="<?php echo ($rowSac['num_sacchetti']); ?>"></input></td>
                                        </table>
                                    </td>
                                </tr>
                                <?php
                            ...
                            <tr>
                                <td class="cella2" style="text-align: right " colspan="2">
                                    ...
                                    <input type="button" id="Salva" onClick="Carica();" value="<?php echo $valueButtonDuplica ?>" />
                                </td>
                            </tr>   
                        </table> 
