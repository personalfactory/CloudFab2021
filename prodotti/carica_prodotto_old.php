                            ...
                            <tr>
                                ...
                                <td class="cella1">
                                    <select name="Mazzetta" id="Mazzetta">
                                        ...
                                        <?php
//                                        $sqlMazzetta = findAllMazzettaDefinite();
                        ...
                        <table width="100%" >
                            ...
                            while ($rowComponente = mysql_fetch_array($sqlComponente)) {
                                ...
                                <tr>
                                    ...
                                    <td class="cella1"><input size="8px" type="text" name="Fluidificazione<?php echo($NComp); ?>" id="Fluidificazione<?php echo($NComp); ?>" value="0" /></td>
                        ...
                        <table width="100%" >
                            ...
                            while ($rowPar = mysql_fetch_array($sqlParProd)) {
                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="cella1"><input type="text" style="width:90%" name="Valore<?php echo($rowPar['id_par_prod']); ?>" id="Valore<?php echo($rowPar['id_par_prod']); ?>" value="<?php echo $rowPar['valore_base'] ?>" /></td>
                        ...
                        <table width="100%" >
                            ...
                            while ($rowPar = mysql_fetch_array($sqlParProd)) {
                                ...
                                <tr>
                                    <td width="30%" class="cella4" title="<?php echo($rowPar['descri_variabile']) ?>"><?php echo($rowPar['nome_variabile']) ?></td>
                                    <td width="40%" class="cella4" ><?php echo($rowPar['descri_variabile']) ?></td>
                                    <td width="15%" class="cella1"><input style="width:90%" type="text" name="Valore<?php echo($rowPar['id_par_prod']); ?>" id="Valore<?php echo($rowPar['id_par_prod']); ?>" value="<?php echo $_POST['Valore' . $rowPar['id_par_prod']]; ?>"  /></td>
                                    <td width="15%" class="cella1"><?php echo $rowPar['uni_mis'] ?></td>
                                </tr>
                                <?php
                            }//End While parametri
