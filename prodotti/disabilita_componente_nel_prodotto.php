                ...
                <table class="table3">
                    ...
                    <tr>
                        <td class="cella6">
                            ...
                            <a id="Conferma" href="disabilita_componente_nel_prodotto.php?Conferma=SI&IdProdotto=<?php echo $IdProdotto ?>&IdComponente=<?php echo $IdComponente ?>&RefBack=<?php echo $RefBack ?>">
...
//                or die("ERRORE 2 : UPDATE serverdb." . $Tabella . "" . mysql_error());
            ...
            begin();
            $disabilitaComponenteProdotto = disabilitaCompProd($IdProdotto,$IdComponente);
            
            $disabilitaComponentePesatura =disabilitaCompPesatura($IdProdotto,$IdComponente);
                    
            if (!$disabilitaComponenteProdotto OR !$disabilitaComponentePesatura) {
