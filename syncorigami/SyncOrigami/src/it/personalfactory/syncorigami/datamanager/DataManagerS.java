...
//        }
        ...
        Integer versioneDbInt=2;
        try {
            
            versioneDbInt=Integer.parseInt(versioneDb);
        
        } catch (Exception ex ) { 
           
           log.error("ERRORE NEL CONVERTIRE LA VERSIONEDB DA STRINGA A INTERO " +  ex.getMessage());
        }
        ...
        //if ((versioneDb.equals("3") & versioneSftw.equals("3")) || macchina.getPassOrigami().equals("3")) {
            if ((versioneDbInt >=3 & versioneSftw.equals("3")) || macchina.getPassOrigami().equals("3")) {
