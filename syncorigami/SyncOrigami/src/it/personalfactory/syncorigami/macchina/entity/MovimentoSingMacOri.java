...
@NamedQueries({
   /** @NamedQuery(name = "MovimentoSingMacOri.findAll", query = "SELECT m FROM MovimentoSingMacOri m"),
    ...
    @NamedQuery(name = "MovimentoSingMacOri.findDatiNuovi", query = "SELECT m FROM MovimentoSingMacOri m WHERE m.dtMov > :dtMov AND m.origineMov=:origineMov")})
public class MovimentoSingMacOri implements Serializable {
    ...
    public String toString() {
        return "it.personalfactory.syncorigami.macchina.entity.MovimentoSingMacOri[ idMovOri=" + idMovOri + " ]";
    }
