...
public class AllarmeOri implements Serializable {
    @OneToMany(mappedBy = "idAllarme")
    private Collection<ValoreAllarmeOri> valoreAllarmeOriCollection;
    ...
    public String toString() {
        return "it.personalfactory.syncorigami.macchina.entity.AllarmeOri[ idAllarme=" + idAllarme + " ]";
    }

    @XmlTransient
    public Collection<ValoreAllarmeOri> getValoreAllarmeOriCollection() {
        return valoreAllarmeOriCollection;
    }

    public void setValoreAllarmeOriCollection(Collection<ValoreAllarmeOri> valoreAllarmeOriCollection) {
        this.valoreAllarmeOriCollection = valoreAllarmeOriCollection;
    }
