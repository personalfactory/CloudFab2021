...
/**@NamedQueries({
    ...
    @NamedQuery(name = "ValoreAllarmeOri.findByInfo1", query = "SELECT v FROM ValoreAllarmeOri v WHERE v.info1 = :info1"),
    @NamedQuery(name = "ValoreAllarmeOri.findByInfo2", query = "SELECT v FROM ValoreAllarmeOri v WHERE v.info2 = :info2"),
    @NamedQuery(name = "ValoreAllarmeOri.findByInfo3", query = "SELECT v FROM ValoreAllarmeOri v WHERE v.info3 = :info3"),
    @NamedQuery(name = "ValoreAllarmeOri.findByInfo4", query = "SELECT v FROM ValoreAllarmeOri v WHERE v.info4 = :info4"),
    @NamedQuery(name = "ValoreAllarmeOri.findByInfo5", query = "SELECT v FROM ValoreAllarmeOri v WHERE v.info5 = :info5")})*/
public class ValoreAllarmeOri implements Serializable {
   ...
   // private AllarmeOri idAllarme;
    ...
    public String toString() {
        return "it.personalfactory.syncorigami.macchina.entity.ValoreAllarmeOri[ id=" + id + " ]";
    }
