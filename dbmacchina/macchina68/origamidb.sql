...
--
-- Table structure for table `allarme`
--
...
CREATE TABLE `allarme` (
  `id_allarme` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) DEFAULT '',
  `descrizione` varchar(255) DEFAULT '',
  `tabella_riferimento` varchar(255) DEFAULT '',
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `allarme`
--

LOCK TABLES `allarme` WRITE;
/*!40000 ALTER TABLE `allarme` DISABLE KEYS */;
INSERT INTO `allarme` VALUES (1,'errore_coclea_vuota','rilevata coclea vuota durante il dosaggio delle materie prime nel processo','ciclo_ori',1,'2017-11-13 10:42:20','test agg','','','',''),(2,'interruzione_manuale_processo','processo interrotto manualmente dall\'operatore','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(3,'errore_dosaggio','rilevato errore di dosaggio in eccesso o in difetto durante la pesatura di un componente','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(4,'contatto_coclea_attivo','rilevatto contatto coclea attivo = sportello coclea aperto o contatto malfunzionante','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(5,'contatto_sportello_attivo','apertura sportello miscelatore in un momento non previsto o contatto malfunzionante','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(6,'contatto_pulsante_stop','digitato pulsante STOP','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(7,'test_iniziale_contatti','Errore test stato iniziale contatti','ciclo_ori',1,'2017-11-06 17:02:41','','','','',''),(8,'errore_comunicazione_IO','Materiale eccessivo sulla bilancia ad inizio processo','ciclo_ori',1,'2017-11-06 17:03:47','','','','',''),(9,'peso_eccessivo_bilancia','Materiale eccessivo sulla bilancia ad inizio processo','ciclo_ori',1,'2017-11-06 17:03:47','','','','',''),(10,'test_impianto_pneumatico','Test impianto pneumatico fallito','ciclo_ori',1,'2017-11-06 17:03:47','','','','',''),(11,'test_microdosatori','Test microdosatori fallito - materiale non sufficiente alla produzione indicata','ciclo_ori',1,'2017-11-13 13:19:47','','','','','');
/*!40000 ALTER TABLE `allarme` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `allarme_ori`
--

DROP TABLE IF EXISTS `allarme_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `allarme_ori` (
...
--
-- Dumping data for table `allarme_ori`
--

LOCK TABLES `allarme_ori` WRITE;
/*!40000 ALTER TABLE `allarme_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `allarme_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `ciclo_ori`
--

DROP TABLE IF EXISTS `ciclo_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ciclo_ori` (
  `id_ciclo` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_ciclo` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `dt_inizio_ciclo` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `dt_fine_ciclo` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `id_ordine` int(11) DEFAULT '0',
  `id_prodotto` int(11) DEFAULT '0',
  `id_cat` int(11) DEFAULT '0',
  `velocita_mix` int(11) DEFAULT '0',
  `tempo_mix` int(11) DEFAULT '0',
  `num_sacchi` int(11) DEFAULT '0',
  `num_sacchi_aggiuntivi` int(11) DEFAULT '0',
  `vibro_attivo` varchar(45) COLLATE utf8_unicode_ci DEFAULT '',
  `aria_cond_scarico` varchar(45) COLLATE utf8_unicode_ci DEFAULT '',
  `aria_interno_valvola` varchar(45) COLLATE utf8_unicode_ci DEFAULT '',
  `aria_pulisci_valvola` varchar(45) COLLATE utf8_unicode_ci DEFAULT '',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id_serie_colore` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `id_serie_additivo` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info1` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info2` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info3` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info4` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info5` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info6` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info7` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info8` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info9` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `info10` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  PRIMARY KEY (`id_ciclo`)
) ENGINE=InnoDB AUTO_INCREMENT=305 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ciclo_ori`
--

LOCK TABLES `ciclo_ori` WRITE;
/*!40000 ALTER TABLE `ciclo_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `ciclo_ori` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ciclo_processo_ori`
--

DROP TABLE IF EXISTS `ciclo_processo_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ciclo_processo_ori` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_ciclo` int(11) DEFAULT '0',
  `id_processo` int(11) DEFAULT '0',
  `dt_inizio_processo` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `dt_fine_processo` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `info1` varchar(255) DEFAULT '',
  `info2` varchar(255) DEFAULT '',
  `info3` varchar(255) DEFAULT '',
  ...
  `info8` varchar(255) DEFAULT '',
  `info9` varchar(255) DEFAULT '',
  `info10` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=712 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ciclo_processo_ori`
--

LOCK TABLES `ciclo_processo_ori` WRITE;
/*!40000 ALTER TABLE `ciclo_processo_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `ciclo_processo_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `componente_pesatura_ori`
--

DROP TABLE IF EXISTS `componente_pesatura_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `componente_pesatura_ori` (
  `id` int(11) NOT NULL,
  `id_prodotto` int(11) DEFAULT '0',
  `id_comp` int(11) DEFAULT '0',
  `metodo_pesa` varchar(45) DEFAULT '',
  `step_dosaggio` varchar(45) DEFAULT '',
  `ordine_dosaggio` int(11) DEFAULT '0',
  `quantita` int(11) DEFAULT '0',
  `toll_eccesso` int(11) DEFAULT '0',
  `toll_difetto` int(11) DEFAULT '0',
  `fluidificazione` varchar(45) DEFAULT '',
  `valore_residuo_fluidificazione` int(11) DEFAULT '0',
  `note` text,
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `info1` varchar(255) DEFAULT '',
  ...
  `info9` varchar(255) DEFAULT '',
  `info10` varchar(255) DEFAULT '',
  `velocita_mix` varchar(255) DEFAULT '',
  `tempo_mix` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `componente_pesatura_ori`
--

LOCK TABLES `componente_pesatura_ori` WRITE;
/*!40000 ALTER TABLE `componente_pesatura_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `componente_pesatura_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `figura_ori`
--

DROP TABLE IF EXISTS `figura_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `figura_ori` (
  `id_figura` int(11) NOT NULL,
  `id_figura_tipo` int(11) DEFAULT '0',
  `nominativo` varchar(255) DEFAULT NULL,
  `codice` varchar(255) DEFAULT NULL,
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_abilitato` timestamp NULL DEFAULT '2017-09-06 09:39:00',
  PRIMARY KEY (`id_figura`),
  KEY `fk_figura_ori_1_idx` (`id_figura_tipo`),
  CONSTRAINT `fk_figura_ori_1` FOREIGN KEY (`id_figura_tipo`) REFERENCES `figura_tipo_ori` (`id_figura_tipo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `figura_ori`
--

LOCK TABLES `figura_ori` WRITE;
/*!40000 ALTER TABLE `figura_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `figura_ori` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `figura_tipo_ori`
--

DROP TABLE IF EXISTS `figura_tipo_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `figura_tipo_ori` (
  `id_figura_tipo` int(11) NOT NULL,
  `figura` varchar(255) DEFAULT NULL,
  `abilitato` tinyint(1) DEFAULT NULL,
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_figura_tipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `figura_tipo_ori`
--

LOCK TABLES `figura_tipo_ori` WRITE;
/*!40000 ALTER TABLE `figura_tipo_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `figura_tipo_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `macchina_ori` VALUES (68,'000000171','GATIM SRL','SRL','3','3','3','',1,'2018-07-25 07:19:37','macchina68','XZCxgUrkufhHs','macchinaXY_pwd');
...
--
-- Table structure for table `movimento_sing_mac_ori`
--

DROP TABLE IF EXISTS `movimento_sing_mac_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `movimento_sing_mac_ori` (
  `id_mov_ori` int(11) NOT NULL AUTO_INCREMENT,
  `id_mov_inephos` int(11) DEFAULT '0',
  `id_materiale` int(11) DEFAULT '0',
  `tipo_materiale` varchar(255) DEFAULT '',
  `quantita` int(11) DEFAULT '0',
  `cod_ingresso_comp` varchar(255) DEFAULT '',
  `cod_operatore` varchar(255) DEFAULT '',
  `operazione` varchar(45) DEFAULT '',
  `procedura_adottata` varchar(255) DEFAULT '',
  `tipo_mov` varchar(45) DEFAULT '',
  `descri_mov` varchar(255) DEFAULT '',
  `dt_mov` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `silo` varchar(45) DEFAULT '',
  `peso_teorico` int(11) DEFAULT '0',
  `id_ciclo` int(11) DEFAULT '0',
  `dt_inizio_procedura` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `dt_fine_procedura` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `abilitato` tinyint(1) DEFAULT '1',
  `origine_mov` varchar(45) DEFAULT '',
  `info1` varchar(255) DEFAULT '',
  `info2` varchar(255) DEFAULT '',
  `info3` varchar(255) DEFAULT '',
  `info4` varchar(255) DEFAULT '',
  ...
  `info9` varchar(255) DEFAULT '',
  `info10` varchar(255) DEFAULT '',
  PRIMARY KEY (`id_mov_ori`)
) ENGINE=InnoDB AUTO_INCREMENT=573 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `movimento_sing_mac_ori`
--

LOCK TABLES `movimento_sing_mac_ori` WRITE;
/*!40000 ALTER TABLE `movimento_sing_mac_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `movimento_sing_mac_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `ordine_sing_mac_ori`
--

DROP TABLE IF EXISTS `ordine_sing_mac_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ordine_sing_mac_ori` (
  `id_ordine_sm` int(11) NOT NULL,
  `id_ordine` int(11) DEFAULT '0',
  `id_prodotto` int(11) DEFAULT '0',
  `ordine_produzione` int(11) DEFAULT '0',
  `contatore` int(11) DEFAULT '0',
  `num_pezzi` int(11) DEFAULT '0',
  `stato` varchar(45) DEFAULT '',
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_produzione` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  `dt_programmata` timestamp NOT NULL DEFAULT '2017-07-31 22:00:00',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `info1` varchar(255) DEFAULT '',
  `info2` varchar(255) DEFAULT '',
  `info3` varchar(255) DEFAULT '',
  ...
  `info9` varchar(255) DEFAULT '',
  `info10` varchar(255) DEFAULT '',
  PRIMARY KEY (`id_ordine_sm`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ordine_sing_mac_ori`
--

LOCK TABLES `ordine_sing_mac_ori` WRITE;
/*!40000 ALTER TABLE `ordine_sing_mac_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `ordine_sing_mac_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `parametro_ordine`
--

DROP TABLE IF EXISTS `parametro_ordine`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `parametro_ordine` (
  `id_par_ordine` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `descrizione` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `abilitato` tinyint(1) DEFAULT '0',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_par_ordine`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `parametro_ordine`
--

LOCK TABLES `parametro_ordine` WRITE;
/*!40000 ALTER TABLE `parametro_ordine` DISABLE KEYS */;
INSERT INTO `parametro_ordine` VALUES (1,'tipo_chimica','CAMBIO TIPO CHIMICA (false KIT CHIMICO - true CHIMICA SFUSA)',1,'2017-11-14 11:56:44'),(2,'numero_confezioni_miscela','NUMERO CONFEZIONI PER MISCELA',1,'2017-11-14 11:56:44'),(3,'peso_confezione','PESO CONFEZIONI SINGOLA',1,'2017-10-27 09:09:50'),(4,'cambio_confezione','CONFEZIONAMENTO IN SACCO (false) O SECCHIO (true)',1,'2017-10-27 09:09:50'),(5,'disabilita_ribalta_confezione','ABILITA (false) - DISABILITA (true) RIBALTA CONFEZIONE',1,'2017-10-27 09:09:50'),(6,'cliente','IDENTIFICATIVO CLIENTE ASSOCIATO ALLA PRODUZIONE (\"\" = DEFAULT: PARAMETRO GLOBALE 40)',1,'2017-10-27 09:09:50'),(7,'cambio_cemento','CAMBIO CEMENTO (true), SE POSSIBILE, O CEMENTO PREVISTO IN FORMULA (false)',1,'2017-10-27 09:09:50'),(8,'prodotto_colorato','PRODOTTO COLORATO (true), NON COLORATO (false)',1,'2017-10-27 09:09:50'),(9,'cambio_bilancia','CAMBIO BILANCIA (false  Bilancia Standard - true  Bilancia Sacchi Valvola Aperta)',1,'2017-11-14 11:56:44');
/*!40000 ALTER TABLE `parametro_ordine` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `prodotto_ori` (
  ...
  `abilitato` tinyint(1) unsigned DEFAULT NULL,
  `dt_abilitato` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tipo` varchar(255) DEFAULT 'PRODUCT',
  `serie_colore` varchar(255) DEFAULT 'NONE',
  `serie_additivo` varchar(255) DEFAULT 'NONE',
  `info1` varchar(255) DEFAULT '',
  `info2` varchar(255) DEFAULT '',
  `info3` varchar(255) DEFAULT '',
  `info4` varchar(255) DEFAULT '',
...
--
-- Table structure for table `valore_allarme_ori`
--

DROP TABLE IF EXISTS `valore_allarme_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `valore_allarme_ori` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_allarme` int(11) DEFAULT '0',
  `valore` varchar(255) DEFAULT '',
  `id_tabella_rif` int(11) DEFAULT '0',
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_abilitato` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `info1` varchar(255) DEFAULT '',
  `info2` varchar(255) DEFAULT '',
...
--
-- Dumping data for table `valore_allarme_ori`
--

LOCK TABLES `valore_allarme_ori` WRITE;
/*!40000 ALTER TABLE `valore_allarme_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `valore_allarme_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `valore_par_ordine_ori`
--

DROP TABLE IF EXISTS `valore_par_ordine_ori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `valore_par_ordine_ori` (
  `id` int(11) NOT NULL,
  `id_par_ordine` int(11) DEFAULT '0',
  `id_ordine_sm` int(11) DEFAULT '0',
  `valore` varchar(255) DEFAULT '',
  `abilitato` tinyint(1) DEFAULT '1',
  `dt_abilitato` timestamp NULL DEFAULT '2017-07-31 22:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `valore_par_ordine_ori`
--

LOCK TABLES `valore_par_ordine_ori` WRITE;
/*!40000 ALTER TABLE `valore_par_ordine_ori` DISABLE KEYS */;
/*!40000 ALTER TABLE `valore_par_ordine_ori` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-07-25  9:19:38
